...
const TestSeries = () => {
  ...
  // Get first test from each available category (safely)
              ...
              {popularTests.map((test, index) => (
                <div key={`${test.id}-${index}`} className="test-card">
                  ...
                  <div className="test-card__footer">
                    <button className="test-card__button">Start Test</button>
                  </div>
                </div>
              ))}
            </div>
            ...
            {filteredTests.map((test, index) => (
              <div key={`${test.id}-${index}`} className="test-card">
                ...
                <div className="test-content">
                  ...
                  <button className='button-test'>Take This Test</button>
                </div>
              </div>
            ))}
          </div>
